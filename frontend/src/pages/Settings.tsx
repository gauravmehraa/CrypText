...
const Settings = () => {
  ...
  return (
    <div className='flex flex-col mx-4 sm:mx-0 overflow-hidden w-full max-sm:-mt-16 lg:w-3/5 h-fit border rounded-lg border-cryptext-gray'>
      ...
      <div className='flex gap-2 bg-cryptext-white/90 h-12 sm:h-14 items-center px-4 py-2 mb-2 text-xl text-cr'>
      ...
      <div className="h-full">
        ...
        <Setting title="Show Message Datestamps" leftText="Off" rightText="On">
          <input
            type="checkbox"
            className="toggle toggle-error toggle-sm sm:toggle-md"
